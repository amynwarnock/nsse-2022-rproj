...
enr_ret_grad <- enr_orig_full %>% 
  ...
  mutate(
    ttd_4 = ifelse(rowSums(across((ends_with("yr1") |
                                     ends_with("yr2") |
                                     ends_with("yr3") |
                                     ends_with("yr4")), 
                                  ~.x == "1")) >= 1,
                   1,
                   0),
    ttd_5 = ifelse(rowSums(across((ends_with("yr5")), 
                                  ~.x == "1")) >= 1,
                   1,
                   0),
    ttd_6 = ifelse(rowSums(across((ends_with("yr6")), 
                                  ~.x == "1")) >= 1,
                   1,
                   0),
    ttd_7 = ifelse(rowSums(across((ends_with("yr7") |
                                     ends_with("yr8") |
                                     ends_with("yr9") |
                                     ends_with("yr10")), 
                                  ~.x == "1")) >= 1,
